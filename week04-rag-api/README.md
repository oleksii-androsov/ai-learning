...
5. Test: `curl -X POST http://localhost:8000/ask -H "Content-Type: application/json" -d '{"question": "What is this document about?"}'`
...
| POST | `/ask` | Accepts `{"question": "..."}`, returns `{"answer": "...", "sources_found": true/false}` |
